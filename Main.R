#*_____________________________________________Import Library_________________________________________________*#
...
#*_____________________________________ Linear Regression: Training Model_____________________________________*#
...
#*__________________________________Linear Regression: Prediction & Result____________________________________*#
...
# End of Linear Regression train and prediction

#*__________________________________ K Nearest Neighbor (KNN): Training Model__________________________________*#
...
#*______________________________ K Nearest Neighbor (KNN): Prediction and Result________________________________*#
...
# Export the prediction result of test data using linear regression and knn in a csv file
write.csv(final_result_data, file = "0075729_Hossain_res", row.names = FALSE)

#*______________________________________End of the Project____________________________________________________*#
#*_______________________________________Md Imran Hossain____________________________________________________*#
